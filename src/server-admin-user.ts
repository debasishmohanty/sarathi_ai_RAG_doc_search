...
if (process.env.NODE_ENV === 'production') {
  const frontendBuildPath = path.join(__dirname, '..', 'frontend', 'dist', 'langchain-chat');
...
if (process.env.NODE_ENV === 'production') {
  app.get('*', (req: Request, res: Response) => {
    const frontendBuildPath = path.join(__dirname, '..', 'frontend', 'dist', 'langchain-chat', 'index.html');
